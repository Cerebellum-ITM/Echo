...
var commandFlags = map[string][]string{
	...
	"deploy":        {"--from", "--limit", "--dry-run", "--force", "--i18n", "--no-i18n", "--commits", "--modules", "--auto", "--push", "--json", "--checkpoint", "--no-checkpoint", "--rollback"},
	"watch":         {"--from", "--remote", "--interval", "--force", "--no-logs", "--no-checkpoint"},
