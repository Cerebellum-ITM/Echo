...
| 18 | connect-command             | `connect [<login>] [--all] [--force]` — mint Odoo web session for any user without password (Python in container via `docker exec`), copy URL + cookie | 04, 06, 10 |
